...
class UpdateProfileRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            'username.max' =>
                'Maximum ' . User::USERNAME_MAX_LENGTH . ' characters allowed.',
            ...
            'phone.not_regex' =>
                EgyptianPhoneRules::foreignPrefixMessage(),

            'phone.regex' =>
                EgyptianPhoneRules::invalidMessage(),

            'phone.min' =>
                EgyptianPhoneRules::lengthMessage(),
